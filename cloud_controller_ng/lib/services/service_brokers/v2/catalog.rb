module VCAP::Services::ServiceBrokers::V2
  class Catalog
    ...
    def valid?
      validate_services#验证service的 valid
      validate_all_service_ids_are_unique#验证service 的id是唯一的，也就是没有重复的
      validate_all_service_dashboard_clients_are_unique#验证service的dashboard client是唯一的
      errors.empty?
    end
