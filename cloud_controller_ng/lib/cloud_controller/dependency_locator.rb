...
module CloudController
  class DependencyLocator
    ...
    #创建一个blob store urlUrlGenerator
    def blobstore_url_generator(use_service_dns=false)
      ...
      Blobstore::UrlGenerator.new(
        connection_options,
        package_blobstore,#package的blobstore client
        buildpack_cache_blobstore,# buildpack cache 的blobstore client
        buildpack_blobstore,# buildpack 的blobstore client
        droplet_blobstore #droplet 的blobstore client
      )
    end
